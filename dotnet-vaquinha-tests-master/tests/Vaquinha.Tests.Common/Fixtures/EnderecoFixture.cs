...
namespace Vaquinha.Tests.Common.Fixtures
{
    ...
    public class EnderecoFixture
    {
        ...
        {
            var endereco = new Faker().Address; //gera um endereçoViewModel válido
            ...
            return faker.Generate(); //retorna um endereçoViewModel válido para ser utilizado nos testes
        }
